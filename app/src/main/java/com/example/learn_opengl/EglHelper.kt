 ...
 */
class EglHelper constructor(surfaceView: EGLSurfaceView) {
    var surfaceView = surfaceView
    var eglGetDisplay: EGLDisplay? = null
    var eglContext: EGLContext? = null
    var surface: Surface = surfaceView.holder.surface
    ...
    fun initEnv() {
        ...
        if (!EGL14.eglChooseConfig(eglGetDisplay, configAttributes, 0, eglConfig,
        ...
        eglContext = EGL14.eglCreateContext(eglGetDisplay, eglConfig[0], EGL14.EGL_NO_CONTEXT, contextAttributes, 0)
        //需要检测Context是否存在
